# Generalized Fermat-Catalan (x^10+y^3=z^4) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Generalized Fermat-Catalan (x^10+y^3=z^4).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/fc-x-10-y-3-z-4-mathlib.git
cd fc-x-10-y-3-z-4-mathlib
lake exe
lake build
```
